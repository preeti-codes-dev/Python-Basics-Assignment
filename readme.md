...
Exception cases such as the division by zero and negative values are addressed.
Menu based programs are carried out with while loops.
...
Producing output in the same format as sample output.
Dealing with jump year logic and prime number logic.
...
The code demonstrates my knowledge of the fundamentals of Python.